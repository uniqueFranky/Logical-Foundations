...
Theorem negation_fn_applied_twice:
  forall (f: bool -> bool), (forall x: bool, f x = negb x) -> forall x: bool, f (f x) = x.
Proof.
  intros f.
  intros H.
  intros x.
...
Theorem andb_false_eq_false:
  forall b: bool, false && b = false.
Proof.
  reflexivity.
Qed.

Theorem orb_false_identity:
...
Proof.
  ...
  intros H.
  destruct b eqn: Eb.
  - rewrite <- andb_true_identity. rewrite -> H. rewrite -> orb_true_eq_true. reflexivity.
  - rewrite <- orb_false_identity. rewrite <- H. rewrite -> andb_false_eq_false. reflexivity.
Qed.
